...
#define CONFIGURE_ARGS " '--with-llvm' '--with-icu' '--enable-debug' '--host=x86_64-apple-darwin' '--prefix=/opt/pginstaller_13.auto/server/staging_cache/osx.build' '--with-ldap' '--with-openssl' '--with-perl' '--with-python' '--with-tcl' '--with-bonjour' '--with-pam' '--enable-thread-safety' '--with-libxml' '--with-uuid=e2fs' '--with-includes=/opt/local/Current/include/libxml2:/opt/local/Current/include:/opt/local/Current/include/security:/opt/local/libexec/llvm-8.0/include:/opt/local/Current/include/openssl/' '--docdir=/opt/pginstaller_13.auto/server/staging_cache/osx.build/doc/postgresql' '--with-libxslt' '--with-libedit-preferred' '--with-gssapi' 'host_alias=x86_64-apple-darwin' 'CFLAGS=-isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX10.15.sdk -mmacosx-version-min=10.13 -arch x86_64 -O2' 'LDFLAGS=-L/opt/local/Current/lib -L/opt/local/libexec/llvm-8.0/lib' 'LLVM_CONFIG=/opt/local/bin/llvm-config-mp-8.0' 'CLANG=/opt/local/bin/clang-mp-8.0 -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX10.15.sdk' 'ICU_CFLAGS=-I/opt/local/Current/include' 'ICU_LIBS=-L/opt/local/Current/lib -licuuc -licudata -licui18n' 'XML2_CONFIG=/opt/local/Current/bin/xml2-config' 'PERL=/Library/edb/languagepack/v1/Perl-5.26/bin/perl' 'PYTHON=/Library/edb/languagepack/v1/Python-3.7/bin/python3'"
...
#define PG_VERSION_STR "PostgreSQL 13.1 on x86_64-apple-darwin, compiled by Apple clang version 11.0.3 (clang-1103.0.32.59), 64-bit"
